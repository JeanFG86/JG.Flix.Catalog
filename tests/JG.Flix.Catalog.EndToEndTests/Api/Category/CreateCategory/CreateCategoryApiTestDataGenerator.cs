        ...
        for (int index = 0; index < totalInvalidCases; index++)
        {
            switch (index % totalInvalidCases)
            {
                case 0:
                    ...
                    invalidInputsList.Add(new object[] { input1, "Name should be at least 3 characteres long" });
                    break;
                case 1:
                    var input2 = fixture.getExampleInput();
                    input2.Name = fixture.GetInvalidNameTooLong();
                    invalidInputsList.Add(new object[] { input2, "Name should be less or equal 255 characteres long" });
                    break;
                case 2:
                    var input3 = fixture.getExampleInput();
                    input3.Description = fixture.GetInvalidDescriptionTooLong();
                    invalidInputsList.Add(new object[] { input3, "Description should be less or equal 10000 characteres long" });
                    break;
                default:
                    break;
            }
